        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between relative">
            ...
            <ul
              ...
              } absolute top-[3px] ml-12 left-[-20px] w-[100%] bg-white shadow-md z-10 p-4 rounded-r-lg lg:static lg:flex lg:items-center lg:gap-[30px] lg:shadow-none lg:bg-transparent`}
            >
            ...
            <div className="hidden lg:block relative">
              ...
              <input
                ...
                type="text"
                className="mr-12 pl-[60px] pr-[60px] outline-none w-[500px] bg-[#F0F0F0] rounded-[20px] py-[9px]"
              />
            </div>
          ...
          <div className="block lg:hidden mt-4">
            <div className="relative mr-10">
              ...
              <input
                placeholder="Search for products..."
                type="text"
                className="pl-[60px] -ml-10 pr-[60px] outline-none w-full bg-[#F0F0F0] rounded-[20px] py-[9px]"
              />
            </div>
          </div>
        </div>
